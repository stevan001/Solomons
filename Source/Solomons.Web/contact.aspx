    ...
    <table class="style8">
        <tr>
            <td>
                Name</td>
            <td>
                <asp:TextBox ID="tbxName" runat="server" Width="143px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                Email</td>
            <td>
                <asp:TextBox ID="tbxEmail" runat="server" Width="143px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                Subject</td>
            <td>
                <asp:TextBox ID="tbxSubject" runat="server" Width="143px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                Message</td>
            <td>
                <asp:TextBox ID="tbxMessage" runat="server" Height="80px" TextMode="MultiLine" 
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:Label ID="lblStatuts" runat="server"></asp:Label>
            </td>
        </tr>
    </table>
</div>
